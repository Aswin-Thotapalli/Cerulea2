...
import { submitAndWatch, type ExtrinsicStatus } from '@/lib/rpc/subscriptions';
        ...
        {tab === 0 && (
          <Box sx={{ p: 3 }}>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2 }}>
              Paste a signed extrinsic in hex format (e.g. from Polkadot.js Apps &rarr; Developer &rarr; Extrinsics).
            </Typography>
            <TextField
              fullWidth
              multiline
