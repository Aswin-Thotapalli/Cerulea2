...
import { fetchBlockByNumber } from '@/lib/api/blocks';
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3, flexWrap: 'wrap' }}>
        ...
        {block && (
          <Box sx={{ display: 'flex', gap: 1 }}>
            <Button
              component={Link}
              href={`/${chain}/blocks/${blockNumber - 1}`}
              size="small"
              variant="outlined"
                ...
                <TableBody>
                  ...
                  <DetailRow label="Parent Hash">
                    {loading ? <Skeleton width={340} /> : block && (
                      <Box component={Link} href={`/${chain}/blocks/${blockNumber - 1}`} sx={{ textDecoration: 'none' }}>
                  ...
                  <DetailRow label="Validator">
                    {loading ? <Skeleton width={220} /> : block?.author ? (
                      <Box component={Link} href={`/${chain}/validators/${block.author}`} sx={{ textDecoration: 'none' }}>
