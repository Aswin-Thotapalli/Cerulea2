                ...
                <TableBody>
                  ...
                  <DetailRow label="From">
                    {loading ? <Skeleton width={280} /> : tx!.from ? (
                      <Box component={Link} href={`/explorer/${chain}/accounts/${tx!.from}`} sx={{ textDecoration: 'none' }}>
                  ...
                  <DetailRow label="To">
                    {loading ? <Skeleton width={280} /> : tx!.to ? (
                      <Box component={Link} href={`/explorer/${chain}/accounts/${tx!.to}`} sx={{ textDecoration: 'none' }}>
