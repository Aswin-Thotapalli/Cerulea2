...
import AddressQR from '@/components/explorer/AddressQR';
import ErrorState from '@/components/explorer/ErrorState';
import { useChainContext } from '@/context/ChainContext';
import { fetchAccount, fetchAccountTxs } from '@/lib/explorer/api/accounts';
import { formatToken } from '@/lib/explorer/format';
                ...
                <TableBody>
                  ...
                  {!loading && account?.isContract && (
                    <DetailRow label="Contract">
                      <Typography
                        component={Link}
                        href={`/explorer/${chain}/contracts/${address}`}
                        variant="body2"
