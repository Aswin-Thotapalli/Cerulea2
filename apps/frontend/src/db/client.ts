...
ensureColumn("projects", "selectedTemplateIds", "TEXT"); // Step 0
ensureColumn("projects", "blueprint", "TEXT"); // Step 1 canonical
ensureColumn("projects", "graph", "TEXT"); // legacy writes (avoid crashes)
ensureColumn("projects", "schemaJson", "TEXT"); // Step 2 schema
ensureColumn("projects", "logicJson", "TEXT"); // Step 2 logic/flows
ensureColumn("projects", "economics", "TEXT"); // Step 3 config
