...
function buildPalette(track: ProjectType): PaletteItem[] {
  const commonComponents: PaletteItem[] = [
    ...
    { id: "c_stat", kind: "component", label: "Stat", category: "Components", type: "Stat", preview: { label: "Metric", value: "—", helper: "Click to bind" } },
  ...
  const applyTemplate = useCallback(
    (templateId: string) => {
      ...
      if (templateId === "chain_dashboard") {
        ...
        const s1 = make("Stat", { label: "Blocks", value: "—", helper: "bind to runtime" });
        const s2 = make("Stat", { label: "TPS", value: "—", helper: "bind to runtime" });
        const s3 = make("Stat", { label: "Validators", value: "—", helper: "bind to runtime" });
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              {showTrackHint} — drag components/templates onto the canvas, then edit properties and bindings.
            </Typography>
          </Box>
        </Stack>
